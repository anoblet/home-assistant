...
-   **RuntimeWarnings**: `research_logs.md` indicates `RuntimeWarning: coroutine 'VeSync.login' was never awaited`. If it is async, we need to ensure *every* call is properly awaited.
