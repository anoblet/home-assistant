...
- Notes for the in-repo VeSync integration (services, logging, feature coverage including Timer, Oscillation, and Mute controls) live in [`docs/custom-components/vesync.md`](./docs/custom-components/vesync.md).
