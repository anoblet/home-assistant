...
NUMBER_DESCRIPTIONS: list[VeSyncNumberEntityDescription] = [
    ...
    VeSyncNumberEntityDescription(
        ...
        and hasattr(device, "set_warm_mist"),
        set_value_fn=lambda device, value: device.set_warm_mist(int(value)),
        value_fn=lambda device: device.details.get("warm_mist_level", 0),
    ),
]
